# COD:MW4 - Modern Warfare 4 RPG Mod untuk Counter-Strike 1.6

COD:MW4 adalah remake dari awal (ground-up remake) dari COD Mod RPG klasik untuk Counter-Strike 1.6, dibangun dari nol untuk AMX Mod X 1.9.
...
Hanya El (pemimpin proyek) dan programmer yang disetujui yang memiliki akses untuk melihat dan mengedit kode sumber.
...
Proyek ini tidak terafiliasi dengan atau didukung oleh O'Zone.

Kredit dan hormat kepada O'Zone untuk menciptakan COD Mod asli yang menginspirasi proyek ini.
